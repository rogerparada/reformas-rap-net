...
public class Mapper : IMapper
{
    ...
    public FullClienteResponse FullClienteEntityToResponse(Cliente cliente) =>
        new()
        {
            Id = cliente.Id,
            Name = cliente.Name,
    ...
    public Cliente ClienteRequestToEntity(ClienteRequest response) =>
        new()
        {
            Name = response.Name,
    ...
    public DocumentoResponse DocumentoToResponse(Documento doc) =>
        new()
        {
    ...
    public FullDocumentoResponse FullDocumentoToResponse(Documento doc) =>
        new()
        {
            IdDocumento = doc.IdDocumento,
            NumeroDocumento = doc.NumeroDocumento,
    ...
    public DocumentoInfoResponse DocumentoToInfoResponse(Documento doc) =>
        new()
        {
            IdDocumento = doc.IdDocumento,
            NumeroDocumento = doc.NumeroDocumento,
    ...
    public Item ItemRequestToEntity(ItemRequest item) =>
        new()
        {
